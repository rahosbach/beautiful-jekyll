...
A zip file of the data used in this analysis can be downloaded [here]({{http://rahosbach.github.io}}/_data/Births_1995_2016.zip).  Here also is the actual citation for the CDC natality data:
